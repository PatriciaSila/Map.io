...
function getAccessibilityColor(gridcode){
    switch(gridcode){
        ...
        case 2: return "#c4d82e";
        case 3: return "#f7941d";
        case 4: return "#ed1c24";
        case 5: return "#c1272d";
...
function getAccessibilityLabel(gridcode){
    switch(gridcode){
        case 1: return "High Accessibility";
        case 2: return "Moderate Accessibility";
        case 3: return "Low Accessibility";
        case 4: return "Very Low Accessibility";
        case 5: return "Poor Accessibility";
...
"<i style='background:#00a651' > </i> Very High<br>"+
"<i style='background:#c4d82e' > </i> Moderate<br>"+
